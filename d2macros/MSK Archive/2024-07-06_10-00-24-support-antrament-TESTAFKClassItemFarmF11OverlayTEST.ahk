...
;;/////////////////////////////////////////////////////////////////////////////////////////////////////////
initial_aim 			:= 4175		; (4350) How long to move the reticle towards the right when aiming for the run path
fasttravel_sleep 		:= 2100		; Z- Default timing to the most common value across ratios. As a fallback in the event no ratio is recognized.
fasttravel_wait			:= 10000	; Increase this if the loop is activating before you finish loading into the landing
pre_arc_sleep 			:= 4700		; (4700) How long you run forward before starting the arc when running to the chest
arc_sleep 				:= 2000		; (2000) How long you arc to the left towards the chest
post_arc_sleep 			:= 2450		; (2400) How long you run forward after the arc is completed. This should end up so you can open the chest
orbit_launcher_right 	:= 900		; ^  How long cursor moves to the right when launching the landing from orbit
orbit_launcher_down 	:= 550		; ^  How long cursor moves to the down when launching the landing from orbit
...
if ((D2Width/D2Height) == (43/18)) {
	fasttravel_sleep := 1525		; How long your cursor scrolls to click on the Landing fast travel
}

;; 21:9 resolution ratio
if ((D2Width/D2Height) == (21/9)) {
	orbit_launcher_right := 1000	; How long cursor moves to the right when launching the landing from orbit
	orbit_launcher_down := 400		; How long cursor moves to the down when launching the landing from orbit
}    
