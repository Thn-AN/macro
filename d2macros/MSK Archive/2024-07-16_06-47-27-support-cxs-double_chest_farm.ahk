...
orbit_landing() ; loads into the landing from orbit
{
    loop, 5
    {
        ...
        Sleep, 1500
        ; Removed color check logic
        ; Added delay to simulate the waiting period
        Sleep, 2000 ; Delay to wait before proceeding

        ; Walking the character after the delay
        d2_click(293, 338, 0) ; click to start walking
        Sleep, 100
        d2_click(295, 338)
        Sleep, 1500

        ; Final click to complete the movement/action
        d2_click(1080, 601, 0)
        Sleep, 100
        d2_click(1080, 601)
        return true
