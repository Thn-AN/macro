...
UpdateOverlay:
    if WinActive("ahk_exe destiny2.exe") {
        ...
        if (overlay.beginDraw()) {
            switch status {
                case 0:
                    overlay.drawText("Please ensure you are at The Landing inside The Pale Heart to Start | [ Start | ] Stop | = Exit | Thrallway.com", 10, 0, 32, 0xFFFFFFFF, "Courier", "olFF000000")
                case 1:
