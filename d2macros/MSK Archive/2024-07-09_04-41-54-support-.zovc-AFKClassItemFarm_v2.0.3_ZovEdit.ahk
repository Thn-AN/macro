...
;; Start Farm Script stuff
	Start_Farm:
360Controller.Buttons.RS.SetState(true) ; Z- Presses a button, that I dont think does anything, but acts as a sacrificial input to tell destiny that we're a controller now
PreciseSleep(100)
