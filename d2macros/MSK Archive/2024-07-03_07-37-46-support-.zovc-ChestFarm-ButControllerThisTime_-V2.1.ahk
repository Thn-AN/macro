...
UpdateOverlay:
	if WinExist("ahk_exe destiny2.exe") 
	{
		...
		{
			inputs := "| F8 - Close Script | Pale Heart chest farming - Zov edition |"
			switch status 
			{
				...
				case 1: ; Z- script is running and counting cycles
					overlay.drawText("| You may now tab out | F5 - Stop Script " . inputs . "`n| " . count . " chests |", 10, 0, font_size, 0xFFFFFFFF, "Courier" , "olFF000000")
