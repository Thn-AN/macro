...
getMsgBoxText() {
    ...
    return "BE IN ORBIT BEFORE STARTING THE MACRO `n ......................................... `n `n- Private Match Crucible`n- Control`n- Javelin-4 `n- 5/10 mins - 10 mins gives more REP`n`n- Start the script when you are at the GREEN LAUNCH BUTTON Screen`n `n ......................................... `n  `n If you want to change KEYBINDS below, check Line 16 in the code `n  `n " startHotkey "   to Start`n " stopHotkey "   to Reload/Stop script`n " exitHotkey "   to Quit/Exit script `n`n READY? Press Yes then Start the macro with the keybind"
}
