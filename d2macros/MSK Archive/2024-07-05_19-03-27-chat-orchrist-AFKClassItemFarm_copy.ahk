...
;;/////////////////////////////////////////////////////////////////////////////////////////////////////////
initialaim 			:= 4175		; (4350) How long to move the reticle towards the right when aiming for the run path
prearcsleep 		:= 4700		; (4700) How long you run forward before starting the arc when running to the chest
arcsleep 			:= 2000		; (2000) How long you arc to the left towards the chest
postarcsleep 		:= 2400		; (2400) How long you run forward after the arc is completed. This should end up so you can open the chest
fasttravelsleep 	:= 2100		; Z- Default timing to the most common value across ratios. As a fallback in the event no ratio is recognized.
orbitlauncherright 	:= 900		; ^  How long cursor moves to the right when launching the landing from orbit
orbitlauncherdown 	:= 550		; ^  How long cursor moves to the down when launching the landing from orbit
...
if ((D2Width/D2Height) == (43/18)) {
	fasttravelsleep := 1525		; How long your cursor scrolls to click on the Landing fast travel
}

;; 21:9 resolution ratio
if ((D2Width/D2Height) == (21/9)) {
	fasttravelsleep := 2100		; How long your cursor scrolls to click on the Landing fast travel
	orbitlauncherright := 1000	; How long cursor moves to the right when launching the landing from orbit
	orbitlauncherdown := 400		; How long cursor moves to the down when launching the landing from orbit
}    
