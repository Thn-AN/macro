...
if WinExist("ahk_exe destiny2.exe") {
	...
	if (overlay.beginDraw()) {
		switch status {
			case 0:
				overlay.drawText("| Please ensure your cursor is just below the button for button layout | thrallway.com | F4 Start |", 10, 0, 32, 0xFFFFFFFF, "Courier", "olFF000000")
			case 1:
				overlay.drawText("| You should press F5 now | F8 Exit |", 10, 0, 32, 0xFFFFFFFF, "Courier", "olFF000000")
		}
		overlay.endDraw()
	}
}
