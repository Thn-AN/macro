...
if ((A_ScreenWidth/A_ScreenHeight) != (16/9) && (A_ScreenWidth/A_ScreenHeight) != (43/18) && (A_ScreenWidth/A_ScreenHeight) != (32/9)){
...
selectloadout(loadoutnum)
{
    ...
    loop,
    {
        ...
        loop, 40
        {
            ...
            if (((color & 0x0F0F0F0) == 2101264) || ((color & 0x0F0F0F0) == 3153952) || ((color & 0x0F0F0F0) == 4206640) || ((color & 0x0F0F0F0) == 2105376))
                loadouts_loaded += 1
        }
