...
if ((A_ScreenWidth/A_ScreenHeight) == (43/18)) {
    ...
    global prearcsleep := 4700			; How long you run forward before starting the arc when running to the chest
    global arcsleep := 2000				; How long you arc to the left towards the chest
    global postarcsleep := 2400			; How long you run forward after the arc is completed. This should end up so you can open the chest
	global initialaim := 4350			; How long to move the reticle towards the right when aiming for the run path
}
...
if ((A_ScreenWidth/A_ScreenHeight) == (16/9)) {
	...
	;; 16:10 resolution (1920x1)
if ((A_ScreenWidth/A_ScreenHeight) == (16/10)) {
	global fasttravelsleep := 2100		; How long your cursor scrolls to click on the Landing fast travel
	global prearcsleep := 4700			; How long you run forward before starting the arc when running to the chest
	global arcsleep := 2000				; How long you arc to the left towards the chest
	global postarcsleep := 2400			; How long you run forward after the arc is completed. This should end up so you can open the chest
...
if ((A_ScreenWidth/A_ScreenHeight) != (16/9) && (A_ScreenWidth/A_ScreenHeight) != (43/18) && (A_ScreenWidth/A_ScreenHeight) != (32/9) && (A_ScreenWidth/A_ScreenHeight) != (16/10) ){
		...
		class ViGEmWrapper {
			...
			CreateInstance(cls){
				try {
					...
					MsgBox,0x40,Exotic Class Farm Script, You do not have ViGEm installed!
					...
					MsgBox,4,Exotic Class Farm Script,The ViGEm installer is now in the same place as this script. Run it to install ViGEm.`n`nPress yes if you need help!
					IfMsgBox, Yes
					{
		...
		class ViGEmTarget {
			...
			__New(){
				...
				if (this.Instance.OkCheck() != "OK"){
					msgbox,4,Exotic Class Farm Script, The .dll failed to load!`n`nPress yes if you need help!
					IfMsgBox, Yes
					{
						Run, https://discord.gg/KGyjysA5WY
						exitapp
...
F4::
    ...
    Loop {
    ;; START
    ;; Reset your instance of the Landing after 20 runs for consistency
        if(ResetCount >= 20){
			ResetCount = 0
