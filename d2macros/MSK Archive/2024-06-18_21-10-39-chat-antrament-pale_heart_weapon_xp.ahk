...
; ==========================================================
F4:: {
    Global overlay := ShinsOverlayClass.call(0,0,1920,1080)
...
select_blooming() {
	Loop {
		Loop {
			if (scan.pixelcountregion(0xFFFCD5, x+570, y+960, 700, 60) > 100) { ; check for the "im tracking" voiceline
				break ; if it's there, break out and go to someone_joined()
			}
		}
		Send "M"
		Sleep(4000)
		dllcall("mouse_event", "uint", 0x8001, "uint", (X+362)*sysx, "uint", (Y+414)*sysy)
		Sleep(100)
		dllcall("mouse_event", "uint", 0x8001, "uint", (X+370)*sysx, "uint", (Y+412)*sysy)
		Sleep(100)
		dllcall("mouse_event", "uint", 0x8001, "uint", (X+375)*sysx, "uint", (Y+412)*sysy)
		Sleep(100)
		dllcall("mouse_event", "uint", 0x8001, "uint", (X+380)*sysx, "uint", (Y+412)*sysy)
		Sleep(100)
		dllcall("mouse_event", "uint", 0x8001, "uint", (X+390)*sysx, "uint", (Y+412)*sysy)
		Sleep(3100)
		DllCall("mouse_event", "UInt", 0x02, "UInt", 0, "UInt", 0) ; click down
		Sleep(1500)
		DllCall("mouse_event", "UInt", 0x04, "UInt", 0, "UInt", 0) ; click up
