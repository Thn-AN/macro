...
#ifwinactive ahk_exe remoteplay.exe ; only have hotkeys work if d2 is active
...
DS4Controller := new ViGEmDS4()
overlay := new ShinsOverlayClass("ahk_exe remoteplay.exe")
...
;; GUI Shit Stolen and tweaked from Antra's Movement script
	...
	;; Setup for Screen resolution differences
		WinGetPos, , , D2Width, D2Height, PS Remote Play
	...
	settingsgui:
		...
		;; Pathing Settings
		gui font, s12 bold q5 cblack, verdana
		gui add, groupbox, x5 YP+40 w280 h270, Chest Pathing Settings
		gui font, s11 norm q5 cblack, verdana
		...
		gui add, text, x15 YP+30 w160 h25 +0x200, Chest Turn Duration:
		gui add, edit, x195 YP+0 w80 h25 vchest_turn_duration, %chest_turn_duration%
...
;; Overlay stuff
	UpdateOverlay:
		if (overlay.beginDraw()) {
			switch status {
				case 0:
					overlay.drawText("| F3 to Launch from Orbit | F4 Start from inside The Landing |`n| F5 Stop | F8 Exit | F9 Settings | Thrallway.com | v" . version . " |", 10, 0, 32, 0xFFFFFFFF, "Courier", "olFF000000")
				case 1:
					overlay.drawText("| F5 Stop | F8 Exit | F9 Settings | Thrallway.com | v" . version . " |`n| " . count . " total runs | Current run in-loop - " . ResetCount . " |", 10, 0, 32, 0xFFFFFFFF, "Courier", "olFF000000")
				case 2:
					overlay.drawText("| F5 Stop | F8 Exit | F9 Settings | Thrallway.com | v" . version . " |", 10, 0, 32, 0xFFFFFFFF, "Courier", "olFF000000")
			}
			overlay.endDraw()
		}
	return
;; Start Farm Script stuff
	Start_Farm:
	DS4Controller.Buttons.RS.SetState(true)
	PreciseSleep(100)
	DS4Controller.Buttons.RS.SetState(false)
	PreciseSleep(100)
		Loop {
	...
	;; Reset your instance of the Landing after 35 runs for consistency
		if(ResetCount >= 40 || ResetCount == -1){
			...
			if(inOrbit == 0) {							; Only runs this if you are not already in orbit
				DS4Controller.Buttons.TouchPad.SetState(true)
				PreciseSleep(100)
				DS4Controller.Buttons.TouchPad.SetState(false)
				PreciseSleep(1000)
				DS4Controller.Buttons.Triangle.SetState(true)
				PreciseSleep(4000)
				DS4Controller.Buttons.Triangle.SetState(false)
			...
			DS4Controller.Axes.LY.SetState(30)			; Z- Bounce the cursor because Bungo be Bungelin
			PreciseSleep(100)							; ↑
			DS4Controller.Axes.LY.SetState(70)			; ↑
			PreciseSleep(100)							; ↑
			DS4Controller.Axes.LY.SetState(50)			; ↑
			PreciseSleep(100)							; ↑
			DS4Controller.Axes.LY.SetState(50)			; ↑
			PreciseSleep(100)							; ↑
			DS4Controller.Axes.LY.SetState(50)			; ↑
			...
			DS4Controller.Axes.LY.SetState(50)			; ↑
			PreciseSleep(700)
			DS4Controller.Buttons.Cross.SetState(true)
			PreciseSleep(100)
			DS4Controller.Buttons.Cross.SetState(false)
			PreciseSleep(fasttravel_delay)
			DS4Controller.Axes.LX.SetState(0)
			PreciseSleep(fasttravel_sleep)
			DS4Controller.Axes.LX.SetState(50)
			PreciseSleep(500)
			DS4Controller.Axes.LY.SetState(70)			; Z- bumps down the map cursor because its a little high for the LZ node sometimes
			PreciseSleep(100)							; ↑
			DS4Controller.Axes.LY.SetState(50)			; ↑
			PreciseSleep(100)							; ↑
			DS4Controller.Axes.LY.SetState(50)			; ↑
			...
			DS4Controller.Buttons.Cross.SetState(false)
			PreciseSleep(1000)
			DS4Controller.Axes.LX.SetState(100)
			PreciseSleep(orbit_launcher_right)
			DS4Controller.Axes.LX.SetState(50)
			PreciseSleep(500)
			DS4Controller.Axes.LY.SetState(100)
	...
	;; FORCE CHEST SPAWN SPOT
		...
		DS4Controller.Axes.RX.SetState(20)
		PreciseSleep(1300)
		DS4Controller.Axes.RX.SetState(50)
		PreciseSleep(200)
		
		;; Move forward into the Pavilion
		DS4Controller.Buttons.LS.SetState(True)
		PreciseSleep(100)
		DS4Controller.Axes.LY.SetState(0)
		PreciseSleep(pavilion_run_time)
		DS4Controller.Axes.LY.SetState(50)
		DS4Controller.Buttons.LS.SetState(False)
		PreciseSleep(200)
		DS4Controller.Axes.RX.SetState(80)
		...
		DS4Controller.Axes.LX.SetState(80)
		PreciseSleep(500)
		DS4Controller.Axes.LX.SetState(50)
		PreciseSleep(100)
	...
	;; RUN AND LOOT CHEST
		...
		DS4Controller.Axes.RX.SetState(15)
		...
		DS4Controller.Axes.RX.SetState(0)
		PreciseSleep(700)
		DS4Controller.Axes.RX.SetState(50)
		PreciseSleep(100)
		;; Run into chest
		...
		DS4Controller.Axes.RX.SetState(0)
		PreciseSleep(chest_turn_duration)
		DS4Controller.Axes.RX.SetState(50)
		PreciseSleep(100)
		DS4Controller.Axes.RY.SetState(95)
		PreciseSleep(700)
		DS4Controller.Axes.RY.SetState(50)
		PreciseSleep(100)
		DS4Controller.Axes.RY.SetState(50)
		PreciseSleep(100)
		;; Loot Chest
		DS4Controller.Buttons.Square.SetState(true)
		PreciseSleep(2000)
		DS4Controller.Buttons.Square.SetState(false)
		PreciseSleep(1000)
