...
if ((A_ScreenWidth/A_ScreenHeight) == (43/18)) {
    ...
    global arcsleep := 2050				; How long you arc to the left towards the chest
    global postarcsleep := 2300			; How long you run forward after the arc is completed. This should end up so you can open the chest
}
		...
		class ViGEmWrapper {
			...
			CreateInstance(cls){
				try {
					...
					MsgBox,0x40,You do not have ViGEm installed!
					...
					MsgBox,4,The ViGEm installer is now in the same place as this script.`n`nPress yes if you need help!
					IfMsgBox, Yes
					{
...
UpdateOverlay:
    if WinActive("ahk_exe destiny2.exe") {
        ...
        if (overlay.beginDraw()) {
            switch status {
                case 0:
                    overlay.drawText("| F4 Start | F5 Stop | F8 Exit | Thrallway.com", 10, 0, 32, 0xFFFFFFFF, "Courier", "olFF000000")
                case 1:
