...
hotkeyDefinitions := ["F4:StartScript", "F5:ReloadScript", "F8:ExitApplication"]
...
getMsgBoxText() {
    ...
    return "- Private match Crucible`n- Control`n- Javelin-4`n- 5/10 mins - 10mins gives more REP`n- Start the script when you are at the GREEN LAUNCH BUTTON Screen`n`n *** `n If you want to change keybinds below, check Line 16 in the code `n *** `n `n- " startHotkey " to Start`n- " stopHotkey " to Reload/Stop script`n- " exitHotkey " to Quit/Exit script `n`n READY?"
}
