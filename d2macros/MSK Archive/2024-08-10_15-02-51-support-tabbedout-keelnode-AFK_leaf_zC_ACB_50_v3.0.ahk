...
; Function to generate message box text based on hotkeys
getMsgBoxText() {
    global hotkeys
    startHotkey := ""
    stopHotkey := ""
    ...
    return "BE IN ORBIT BEFORE STARTING THE MACRO `nReady the GREEN LAUNCH BUTTON  `n ......................................... `n CURRENT MACRO: [name of file, include handle]   `n `n `n- MUST HAVE 100 MOBILITY `n- UNEQUIP Sprint/movement boost exotics (Stompees, Transversive steps, lightweight frame weapons etc for better consistency) `n- Private Match Crucible`n- Game Type: Zone Control`n- Game Map: Javelin-4 `n `n- Score Limit: 25 OR 50 `n    - 25 DOES NOT give Crucible Rep | 50 DOES give Crucible rep `n    - 25 is ~1 minute faster than 50 `n    - If NO want rep, use script named -> AFK_leaf_zC_ACB_25  `n    - If YES want rep, use script named -> AFK_leaf_zC_ACB_50 `n `n - Super Charge Rate: 50x `n - Use BUBBLE TITAN or WELL WARLOCK to cast super for orbs `n`n ......................................... `n If you want to change KEYBINDS below, check ~Line 2251 in the code under HOTKEYS section `n  `n " startHotkey "   to Start`n " stopHotkey "   to Reload/Stop script`n " exitHotkey "   to Quit/Exit script `n`n READY? Press Yes then "startHotkey " to begin the macro "
}
...
StartScript:
    ...
    Loop {
        ...
        360Controller.Axes.LX.SetState(50)
        Sleep, 2000
        ; ; Switch to heavy incase equipped a LIGHTWEIGHT FRAME weapon -------- turns out you spawn in holding your heavy? shouldn't matter anyway
        ...
        ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; Cap FLAG B - ignore
            ...
            ;;;; The bottom is cos i was stupid and forgot I already should capture flag A at the start lol... 
            ;;;; Leave it or delete it, either way it's memories for me lol
    
    
            ; ; Turn LEFT to look at wall towards A
            ; 360Controller.Axes.RX.SetState(20)
            ; PreciseSleep(3100) 
            ; 360Controller.Axes.RX.SetState(50)
            ; Sleep, 200
    
            ; ; Sprint Forward towards WALL hallway
            ; 360Controller.Buttons.LS.SetState(true)
            ; 360Controller.Axes.LY.SetState(100)
            ; PreciseSleep(4200)
            ; 360Controller.Axes.LY.SetState(50)
            ...
            ; ; Strafe right to get character staring at Flag A
            ; 360Controller.Axes.LX.SetState(80)
            ; PreciseSleep(3000)
            ; 360Controller.Axes.LX.SetState(50)
            ; Sleep, 200
    
            ; ; Sprint Forward to capture A
            ; 360Controller.Buttons.LS.SetState(true)
            ; 360Controller.Axes.LY.SetState(100)
            ; PreciseSleep(5500)
            ; 360Controller.Axes.LY.SetState(50)
