...
; The main function of this script was made by kielch !
;####################
...
UpdateOverlay:
    if WinActive("ahk_exe destiny2.exe") {
        ...
        if (overlay.beginDraw()) {
            switch status {
                case 0:
                    overlay.drawText("| Please ensure you are at the launch screen | F4 Start | F8 Exit | Thrallway.com", 10, 0, 32, 0xFFFFFFFF, "Courier", "olFF000000")
                case 1:
                    overlay.drawText("| You can tab out now | F5 Stop | F8 Exit | Thrallway.com", 10, 0, 32, 0xFFFFFFFF, "Courier", "olFF000000")
            }
            overlay.endDraw()
        } else {
                overlay := new ShinsOverlayClass("ahk_exe destiny2.exe")
