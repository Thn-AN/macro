...
getMsgBoxText() {
    ...
    return "BE IN ORBIT BEFORE STARTING THE MACRO `n ......................................... `n `n `n- MUST HAVE 100 MOBILITY `n-Make sure to unequip Sprint boost exotics (Stompees, Transversive steps etc) `n- Private Match Crucible`n- Game Type: Zone Control`n- Map: Javelin-4 `n- Match Score Limit: 25 `n - Super Charge Rate: 50x `n- Use BUBBLE TITAN or WELL WARLOCK -> script presses super button `n`n- Press " startHotkey " to start the script when you are at the GREEN LAUNCH BUTTON Screen`n `n ......................................... `n  `nIf you want to change KEYBINDS below, check ~Line 2251 in the code under HOTKEYS section `n  `n " startHotkey "   to Start`n " stopHotkey "   to Reload/Stop script`n " exitHotkey "   to Quit/Exit script `n`n READY? Press Yes then Start the macro `n Starting it while tabbed out has better consistency  "
}
