...
if WinExist("ahk_exe destiny2.exe") {
	...
	if (overlay.beginDraw()) {
		switch status {
			case 0:
				overlay.drawText("| Please ensure your cursor is over what you want to buy | thrallway.com | F4 Start | F8 Exit |", 10, 0, 32, 0xFFFFFFFF, "Courier", "olFF000000")
			case 1:
				overlay.drawText("| You can tab out now | Thrallway.com for more macros | F5 Stop | F8 Exit |", 10, 0, 32, 0xFFFFFFFF, "Courier", "olFF000000")
		}
		overlay.endDraw()
	}
}
