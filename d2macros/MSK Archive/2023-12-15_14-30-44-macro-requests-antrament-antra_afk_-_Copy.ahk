...
class ViGEmWrapper {
	...
	CreateInstance(cls){
		try {
			...
			MsgBox The installer named `"ViGEmBus_1.21.442_x64_x86_arm64.exe`" has been placed in the same place as this script.`n`nYou can use it to install ViGEm.`n`nYou can then delete the installer. Join our Discord if you need any help: https://discord.gg/KGyjysA5WY
			exitapp
		}
	}
