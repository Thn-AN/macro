...
if ((A_ScreenWidth/A_ScreenHeight) == (43/18)) {
    global fasttravelsleep := 1500
    global prearcsleep := 4300
    global arcsleep := 2000
    global postarcsleep := 2400
}

if ((A_ScreenWidth/A_ScreenHeight) == (16/9)) {
	global fasttravelsleep := 2100
    global prearcsleep := 4700
    global arcsleep := 2000
    global postarcsleep := 2500
}
    ...
    if WinActive("ahk_exe destiny2.exe") {
        ...
        if (overlay.beginDraw()) {
            switch status {
                ...
                case 1:
                    overlay.drawText("| F5 Stop | F8 Exit | Thrallway.com `n| " . count . " runs | Current loop run - " . ResetCount . "|", 10, 0, 32, 0xFFFFFFFF, "Courier", "olFF000000")
				case 2:
