...
#ifwinactive ahk_exe GeForceNOW.exe ; only have hotkeys work if d2 is active
...
overlay := new ShinsOverlayClass("ahk_exe GeForceNOW.exe")
...
;; GUI Shit Stolen and tweaked from Antra's Movement script
	startup:
		...
		if fileexist(settingsini) {
			...
			if(cleanupoldshit203 != 1){
				...
				WinActivate, Destiny 2 on GeForce NOW
			}
		}
		else {
			gosub, inisetup
	...
	;; Setup for Screen resolution differences
		WinGetPos, , , D2Width, D2Height, Destiny 2 on GeForce NOW
